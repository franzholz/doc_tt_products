...
There are multiple ways to create a shop. The usual way is to create :ref:`folders <t3coreapi:list-of-page-types-sysfolder>` for the products and lists and single sites where the products are displayed. If you want to build a bigger shop with TYPO3, this will become a little bit unhandy.
