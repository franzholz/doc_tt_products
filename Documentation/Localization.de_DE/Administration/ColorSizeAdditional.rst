...
..  code-block:: html
    ...
    <!-- ###display_variant1### -->
    <!-- ###display_variant2### -->
    ###GW2B### Größe: ###GW2E### < select style="font-size: 10px"
...
Der Feldname aller Felder in der Listenansicht und der Warenkorbansicht wird mit dem Marker :html:`###FIELD_NAME###` angesprochen. Dieser Marker wird intern im Shop durch einen Feldnamen ersetzt, damit das Feld ausgelesen und richtig zugeordnet werden kann.
