...
:composer:`jambagecom/tt-products` is based on the :composer:`jambagecom/table` and :composer:`jambagecom/div2007`. So you have to always update to the latest versions of these extensions when you update tt_products.

If you want to use the variant fields (colour, quantity ...), you must also set the constants
:typoscriptL`'selectColor` and :typoscript:`selectSize` at :typoscript:`0`  or :typoscript:`1` , :typoscript:`2` , :typoscript:`3` . 
